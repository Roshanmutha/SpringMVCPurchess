...
body{font:12px/16px normal arial; width:100%; height:100%;
...
.content ol li:last-child{ margin-top:10px;}
...
<h3 class="total-balance">
	...
	<form:form action="loadCustomer" method="post">
			<fieldset>
				<legend>Search Customer</legend>
				<ol>
					<li><label>Load by Mobile :</label> <input id="mobileSearch" type="text"
						name="mobileSearch"> <input type="submit" name="Search"
	...
	<form:form action="loadTransaction" method="post">	
			<fieldset>
				<legend>Load Invoice</legend>
				<ol>
					<li><label>Invoice ID :</label>  <input id="transactionid" type="text"
						name="transactionid"> <input type="submit" name="Search"
	...
	<form:form commandName="transactionHolder" action="newTransaction"
		method="post">
			<fieldset>
				...
				<ol>
					<li><label for=name>Customer Name:
					</label> <form:input path="name" type="text" required="true"
							placeholder="Enter First Name and last Name!"/></li>
					
					<li><label for=name>Customer Area:
					</label> <form:input path="area" type="text" required="true"
							placeholder="Cutomer Address!"/></li>
					
					<li><label for=name>Customer
							BirthDate :</label> <form:input path="dob" type="date" required="false" /><label>&nbsp;&nbsp; Enter in format 'MM-DD-YYYY'</label></li>
					
					<li><label for=email>Customer
							Email :</label> <form:input path="email" type="text" required="false"
							placeholder="Enter Email address!"/></li>
					
					<li><label for=phone>Customer
							Phone :</label> <form:input path="phone" type="text" required="true"
							placeholder="Enter Phone number!" /></li>					

					<li><legend>Purchess details : </legend><br>
 <div class="CSSTableGenerator" >
						
						<div class="CSSTableGenerator" ><table id="dataTable" >
					<tr bgcolor="Grey">
						<td>Select</td>
						<td>Product Name</td>
						<td>Quantity</td>
					...
					<TR>
								...
								<td><INPUT type='text'
									...
									placeholder="Enter Number Of Items!"/></td>
								<td><INPUT type='text'
