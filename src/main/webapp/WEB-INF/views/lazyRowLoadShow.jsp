...
<title>Puneri Fashion- Show Transaction</title>
...
<form:form commandName="transactionHolder" action="newTransaction" method="get">        


             <div>
            
             <fieldset >
                <legend>Last transaction</legend>
				<ol>
					
					<b><label for=name >Invoice Number: </label>
					<label>##${transactionHolder1.invoiceNumber}</label></b><br><br>
					To, <br>
					<br><b> <label>${transactionHolder1.name}</label></b>
					<br><label> ${transactionHolder1.email}</label>
					<br><label> ${transactionHolder1.phone}</label>
					<br>

				</ol>

				<ol><br><label><b>Purchess Details:</b></label>
                		<div class="CSSTableGenerator" ><TABLE id="dataTable2">
                		<TR bgcolor="grey">					         
					            <TD><label><c:out value="Name"/></label></TD>
					            <TD><label><c:out value="No of Items"/></label></TD>
					            <TD><label><c:out value="Per Unit Price"/></label></TD>	
					            <TD><label><c:out value="Total"/></label></TD>	
					        </TR>
                		<c:forEach items="${transactionHolder1.operationParameterses}" var="value">
					        <TR>					         
					            <TD><label><c:out value="${value.name}"/></label></TD>
					            <TD><label><c:out value="${value.items}"/></label></TD>
					            <TD><label><c:out value="${value.price}"/></label></TD>	
					            <TD><label><c:out value="${value.price*value.items}"/></label></TD>	
					        </TR>
					         </c:forEach>
					    </TABLE></div>
				...
				<ol style="float: right; ">
                       <b> <label for=phone ><br>Total Amount paid :</label></b>
                         <label>Rs. ${transactionHolder1.totalAmount}
                </ol>
                ...
                <ol style="float: right; ">
					...
					<br><br>
					<label>From,</label> <br>
					<br><b><label>Puneri Fashion,</label></b>
					<br><label>Porwal Rd, Kutwal Colony, Lohgaon,</label>
					<br><label>Pune, Maharashtra 411047</label>
					<br><label>Contact : 9552807811</label>
            ...
            <fieldset >
             <legend><label>Thanks for purchess!! Visit Again !</label></legend><br>
