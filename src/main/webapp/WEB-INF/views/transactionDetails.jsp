		...
		<div >
            ...
            <div class="CSSTableGenerator" >
				...
				<tr >
					...
					<td><c:out value="${transaction.id}" /></td>
						<td><label><c:out value="${transaction.name}" /></label></td>
						<td><label><c:out value="${transaction.mobile}" /></label></td>
						<td><label><c:out value="${transaction.area}" /></label></td>
						<td><label><c:out value="${transaction.totalAmount}" /></label></td>
						<td><label><c:out value="${transaction.createdDate}" /></label></td>
					</tr>
			 ...
			 <fieldset>
                <legend><label>Transaction Items</label></legend>
			...
			<table >
				...
				<c:forEach var="item" items="${itemList}">
					<tr>
						<td><label><c:out value="${item.name}" /></label></td>
						<td><label><c:out value="${item.quantity}" /></label></td>
						<td><label><c:out value="${item.price}" /></label></td>
						<td><label><c:out value="${item.price*item.quantity}" /></label></td>
					</tr>
				</c:forEach>
			</table> </div>
			</fieldset>
			<fieldset>
			<div style="float: right;padding-right: 90px"><b><label>Total Amount : Rs. ${transaction.totalAmount}</label></b></div>
			</fieldset>
